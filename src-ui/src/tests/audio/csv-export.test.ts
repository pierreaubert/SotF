...
import { CSVExporter, type ExportData, type CaptureMetadata } from '../../modules/audio/csv-export';
...
describe('csv-export', () => {
  ...
  describe('generatePreview', () => {
    it('should generate preview with header and data rows', () => {
      ...
      expect(preview).toContain('Frequency(Hz),Raw_SPL(dB),Smoothed_SPL(dB),Raw_Phase(deg),Smoothed_Phase(deg)');
