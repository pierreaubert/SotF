...
export class CaptureModalManager {
  ...
  private initializeElements(): void {
    ...
    // Records management elements
    this.recordsSidebar = document.getElementById('records_sidebar');
    this.recordsList = document.getElementById('records_list');
    this.recordsToggleBtn = document.getElementById('records_toggle_btn') as HTMLButtonElement;
    this.recordsSelectAllBtn = document.getElementById('records_select_all_btn') as HTMLButtonElement;
    this.recordsDeselectAllBtn = document.getElementById('records_deselect_all_btn') as HTMLButtonElement;
    this.recordsDeleteSelectedBtn = document.getElementById('records_delete_selected_btn') as HTMLButtonElement;
  }
